package com.andres.rangel.quotesapp.model
...
class QuoteProvider {
    companion object{
        ...
        private val quote = listOf<QuoteModel>(
            ...
            QuoteModel(
                quote = "If debugging is the process of removing software bugs, then programming must " +
            ...
            QuoteModel(
                quote = "Measuring programming progress by lines of code is like measuring aircraft " +
